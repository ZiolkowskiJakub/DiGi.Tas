...
**DiGi.Tas** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.Tas.Core](DiGi.Tas.Core)** (Path: `DiGi.Tas\DiGi.Tas.Core`)
* **[DiGi.Tas.TBD](DiGi.Tas.TBD)** (Path: `DiGi.Tas\DiGi.Tas.TBD`)
* **[DiGi.Tas.TIC](DiGi.Tas.TIC)** (Path: `DiGi.Tas\DiGi.Tas.TIC`)
